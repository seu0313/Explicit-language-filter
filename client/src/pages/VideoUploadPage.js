            ...
            <div className="responsive-video-grid-container">
                ...
                <form method="POST" onSubmit={fileSubmit}>
                    ...
                    <TextField 
                        ...
                        fullWidth value={VideoDescription} 
                    ...
                    >
                        <Modal.Header>{VideoFile && !TransferFailState ? "비속어 처리 중.." : "경고!" }</Modal.Header>
                        <Modal.Content image>
                    ...
                    <FormControl component="fieldset">
                        ...
                        <RadioGroup aria-label="method" name="method1" value={value} onChange={handleValueChange}>
